...
<template>
  <div class="common-item">
    ...
    <n-radio-group class="common-radio-group" v-model:value="series.smooth" name="radiogroup"
  ...
  <div class="common-item">
    ...
    <n-select class="common-small-select" :options="lineTypeOptions" size="small"
      v-model:value="series.lineStyle.type" />
    <el-input-number v-model="series.lineStyle.width" class="common-number-input" :min="1" :max="44"
  ...
  <div class="common-item">
    ...
    <n-select class="common-medium-select" :options="symbolTypeOption" :disabled="!series.showSymbol" size="small"
